 ...
 */
export const validateRequestBody = (schema : ZodObject) => { // on the go , take any req body schema , and create a middleware to validate that
...
export const validateQueryParams = (schema : ZodObject) => { // on the go , take any req body schema , and create a middleware to validate that
    return async (req : Request , res : Response , next : NextFunction) => {
        try{
